...
// Catch session errors for the modal
if (isset($_GET['error'])) {
...
<head>
  ...
  <title>SpendSync - Premium Login</title>
  ...
  <style>
    ...
    .login-form-card {
      background: rgba(255, 255, 255, 0.45); /* Mas transparent para lumabas yung blur */
    ...
    /* Custom Floating Animation for Icons */
    @keyframes float {
    ...
    /* Glass effect for smaller icon cards */
    .glass-icon-card {
    ...
    .modal-message { color: var(--text-main); font-size: 1rem; line-height: 1.5; margin-bottom: 1.5rem; font-weight: 500;}
    .modal-btn {
...
<body>
  ...
  <div class="flex h-screen w-full items-center justify-center p-4 lg:p-8 relative z-10">
    ...
    <div class="w-full max-w-5xl login-form-card flex flex-col lg:flex-row overflow-hidden shadow-[0_20px_60px_rgba(37,99,235,0.15)]">
      ...
      <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-white/30 to-blue-50/20 p-12 flex-col justify-center items-center relative border-r border-slate-200/40">
        ...
        <div class="mt-12 text-center left-anim">
          ...
          <p class="text-slate-600 font-medium text-sm leading-relaxed max-w-xs mx-auto">
            Manage budgets, track daily transactions, and gain insights into your spending habits seamlessly.
          </p>
        </div>

      </div>

      <div class="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center bg-white/20 right-anim">
        ...
        <div class="mb-8 text-center lg:text-left">
          <h2 class="text-3xl font-bold mb-2 text-slate-900">Hello, <br>Welcome back</h2>
          <p class="text-slate-600 font-medium">Ready to manage your finances?</p>
        </div>

        <div class="flex border-b border-slate-300/50 mb-8">
          <button class="flex-1 pb-3 text-center font-bold text-blue-600 border-b-2 border-blue-600">Login</button>
          <a href="signup.php" class="flex-1 pb-3 text-center font-semibold text-slate-500 hover:text-slate-700 transition-colors">Sign Up</a>
        </div>
        ...
        <form id="loginForm" action="" method="POST" class="space-y-5">
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="email" name="email" placeholder="Enter your email" class="w-full pl-11 pr-4 py-3.5 rounded-xl light-input outline-none font-medium" required>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="password" id="passwordInput" name="password" placeholder="Enter your password" class="w-full pl-11 pr-12 py-3.5 rounded-xl light-input outline-none font-medium" required>
          ...
          <div class="flex items-center justify-between pt-2">
            <div class="flex items-center">
              <input type="checkbox" id="remember" class="w-4 h-4 rounded border-slate-400 text-blue-600 focus:ring-blue-600 bg-white/50">
              <label for="remember" class="ml-2 text-sm font-medium text-slate-700">Remember me</label>
            </div>
            <a href="forgot_password.php" class="text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors">Forgot password?</a>
          </div>
        ...
        <p class="mt-8 text-center text-sm text-slate-600 font-medium">
          Don't have an account? <a href="signup.php" class="text-blue-600 hover:text-blue-800 font-bold transition-colors">Click here</a>
        </p>
